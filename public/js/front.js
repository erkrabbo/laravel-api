...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    Axios.get("".concat(window.location.origin, "/api/posts/").concat(this.slug)).then(function (res) {
      return _this.post = res.data.post;
    });
  }
});
...
var render = function () {
  ...
  return _c("div", { staticClass: "row" }, [
    ...
    _vm._v(" "),
    _vm.post ? _c("p", [_vm._v(_vm._s(_vm.post.content))]) : _vm._e(),
  ])
}
var staticRenderFns = []
render._withStripped = true
...
var routes = [{
  ...
  path: '/show/:slug',
  name: 'show',
  component: _components_Show__WEBPACK_IMPORTED_MODULE_1__["default"],
  props: true
}];
...
module.exports = __webpack_require__(/*! C:\Users\luca9\Desktop\BOOLEAN COURSE\laravel-api\resources\js\front.js */"./resources/js/front.js");
